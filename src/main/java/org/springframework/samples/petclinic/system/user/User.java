...
@Entity @Table(name = "user_", indexes = {
...
public class User implements UserDetails {
	...
	@Column(name = "PASSWORD", length = 500) private String password;

	@Column(name = "ENABLED") private Boolean enabled;

	@ManyToMany @JoinTable(joinColumns = @JoinColumn(name = "user_id")) @BatchSize(size = 50)
